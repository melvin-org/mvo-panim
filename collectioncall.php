...
$query = "SELECT * FROM products WHERE collection_id ='1'";
$query2 = "SELECT * FROM collections WHERE collection_id ='1'";
$result = mysqli_query($con, $query); 
$result2 = mysqli_query($con, $query2);

$collection = mysqli_fetch_assoc($result2);


if (mysqli_num_rows($result) == 0) {
    echo "<p>No products found.</p>";
} else {
    echo "<p align=center><b>".$collection['collection_name']."</b></p>";

...
<body>
    ...
    <div class="bg-modal-addUsers">

        <div class="modal-content-addUsers">
            <form class="form-horizontal" method="POST" action="users_add.php" id="addform" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <label for="userrole" class="col-sm-1 control-label">Role</label>
                    <div class="col-sm-5">
            ...
            <div class="modal-footer">
                <a href="users.php"><button type="button" class="btn btn-default btn-flat pull-left" data-dismiss="modal"><i class="fa fa-close"></i> Close</button></a>

        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                ...
                if (mysqli_num_rows($result) == 0) {
                    ...
                    echo "<form class='form-horizontal' action='users_update.php' method='POST' enctype='multipart/form-data'>";
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        echo "<label for='userrole' class='col-sm-1 control-label'>Role: </label><div class='col-sm-3'><select class='form-control' id='userrole' name='userrole' required>";
                            if($row['role'] == 'Manager'){
                                echo "<option value='" . $row['role'] . "' selected>" . $row['role'] . "</option>"; 
                                echo "<option value='ITAdmin'>IT Admin</option>"; 
